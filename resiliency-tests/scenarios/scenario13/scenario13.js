	...
	return {
		...
		run: function() {
			async.series([
				...
				async.apply(elasticsearch.setReallocationTimeout, index1,'1m'),
				async.apply(elasticsearch.setReallocationTimeout, index2,'1m'),
				...
				async.apply(
				  runner.runScripts,
				  'scenarios/scenario13/scenario13.sh',
				  `/home/${options.cluster.username}/scenario13.sh`,
				  scriptsArgs
				)
			],
			function (err, result) {
